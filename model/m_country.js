...
module.exports.dataDeleteById = async (country, admin) => {
  const data = await Table.findOneAndRemove({ country: country, admin: admin });
  return data;
};
////////////////////////////
//TODO:Use by State route
module.exports.getDataByFieldFilterData = async (country, admin) => {
    const data = await Table.find(
